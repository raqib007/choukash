...
@Component({
	selector: 'app-location-shipping-address',
	templateUrl: './location-shipping-address.component.html',
	styleUrls: ['./location-shipping-address.component.scss']
})
export class LocationShippingAddressComponent implements OnInit {
    formData = {
		bname: '',
		authority: '',
		fname: '',
